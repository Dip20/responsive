    ...
    <div id="outer_container">
      <div class="sign_container">
        <div class="sign_div" style="display: flex; margin: 20px;">
          ...
          <div style="display: flex; width: 40%; height: 52px; margin-top: 34px; margin-left: auto; font-weight: bold; font-size: 18px; font-family: sans-serif; justify-content: center;">
              <div style="width: 120px; height: 20px; text-align: center; color: white; padding: 15px; background-color: #A60000; border-radius: 25PX;">Feed a Link</div>
              <div style="margin-left:50px; color: white;">
                <img src="images/hamburgerIcon.png" id="hamicon" style="width: 50px;">
              </div>
              <div style="display: flex;">
                <div style="margin-left:50px; width: 50px; border: 3px solid #A60000; border-radius: 50px; overflow: hidden;">
                  <img src="userdata/profilePhotos/164.jpg" id="profilePic" style="width: 50px">
                </div>
                <div style="margin-top:5px; margin-left: 10px;">
                  <div style="color: white;">User's Name</div>
                  <div style="color: white;">User's Surname</div>
                </div>
              </div>
          </div>
        </div>
